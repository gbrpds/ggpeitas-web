  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center pt-[68px] px-[5%]">
      <div className="max-w-[560px] w-full text-center py-16">
        <Clock size={80} className="text-[#F5C400] mx-auto mb-6" />
        <h1 className="font-display text-[40px] tracking-[2px] mb-3">PAGAMENTO PENDENTE</h1>
        {orderId && (
          <>
            <p className="text-white/50 mb-2 text-[15px]">Número do pedido:</p>
            <p className="font-mono text-[#F5C400] text-[20px] mb-4">#{orderId.slice(-8).toUpperCase()}</p>
          </>
        )}
        <p className="text-white/40 text-[14px] mb-10 leading-relaxed">
          Seu pagamento está sendo processado. Assim que confirmado, seu pedido será preparado automaticamente.
          Acompanhe o status em <strong className="text-white/60">Meus Pedidos</strong>.
        </p>
