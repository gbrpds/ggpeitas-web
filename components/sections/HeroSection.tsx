...
export function HeroSection() {
  ...
  return (
    <section id="home" className="h-[88vh] relative flex items-center pt-[68px]">
      ...
      {/* Content */}
      <div className="relative z-10 px-[5%] pl-[12%] py-4 max-w-[680px] animate-fade-up">
        {/* Badge */}
        <div className="inline-flex items-center gap-3 bg-[rgba(245,196,0,0.08)] border border-[rgba(245,196,0,0.25)] px-4 py-2 rounded-sm mb-4">
        ...
        {/* Title */}
        <div className="font-display leading-[0.9] tracking-[2px] mb-4" style={{ fontSize: 'clamp(48px,7vw,100px)' }}>
        ...
        {/* Slogan */}
        <div className="flex items-center gap-3 text-[13px] tracking-[4px] uppercase text-white/40 my-4">
        ...
        <div className="hidden md:flex gap-10 animate-fade-up" style={{ animationDelay: '0.2s' }}>
          {[['100%', 'Original'], ['7+', 'Seleções'], ['48h', 'Envio']].map(([n, l]) => (
            <div key={l}>
              <div className="font-display text-[28px] text-[#F5C400] leading-none">{n}</div>
      ...
      {/* Kit cards */}
      <div className="absolute right-0 bottom-0 top-[68px] w-[50%] hidden lg:flex items-center justify-center z-[1]" style={{ animationDelay: '0.15s' }}>
        {[
